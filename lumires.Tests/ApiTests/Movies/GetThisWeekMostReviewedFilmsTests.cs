...
using lumires.Api.Features.Films.GetThisWeekMostReviewed;
...
internal sealed class GetThisWeekMostReviewedFilmsTests
{
    ...
    [Test]
    public async Task GetThisWeekMostReviewed_Should_Be_200_When_Empty()
    {
        //Arrange
    ...
    [Arguments(1, "2010-07-16", "/poster1.jpg", 4.5, 200, 20, 100, "Warner")]
    [Arguments(42, "2014-11-07", "/poster2.jpg", 3.8, 350, 20, 200, "HBO")]
    public async Task GetThisWeekMostReviewed_Should_ReturnCachedResponse_On_SecondCall(
        int externalId,
        string dateStr,
        string posterPath,
        float voteAverage,
    ...
    [Arguments(1, "2010-07-16", "/poster1.jpg", 4.5, 200, 20, 100, "Warner")]
    [Arguments(42, "2014-11-07", "/poster2.jpg", 3.8, 350, 20, 200, "HBO")]
    public async Task GetThisWeekMostReviewed_Should_CacheSeparately_Per_Language(
        int externalId,
        string dateStr,
        string posterPath,
        float voteAverage,
    ...
    [Test]
    public async Task GetThisWeekMostReviewed_Should_ReturnCachedData_WhenDataAccessFails_FailSafe()
    {
        // Arrange
        var callCount = 0;
        var dbContextMock = new Mock<IAppDbContext>();
        ...
        var ep = Factory.Create<Endpoint>(
            _currentUserMock.Object,
            _cache,
            new DataAccess(dbContextMock.Object));
    ...
    [Test]
    public async Task GetThisWeekMostReviewed_Should_ReadLangCulture_OnEveryRequest()
    {
        // Arrange
    ...
    [Test]
    public async Task GetThisWeekMostReviewed_Should_ReturnEmptyResponse_WhenDataAccessReturnsNull()
    {
        // Arrange
        var movies = new List<Film>().BuildMockDbSet();
        var dbContextMock = new Mock<IAppDbContext>();
