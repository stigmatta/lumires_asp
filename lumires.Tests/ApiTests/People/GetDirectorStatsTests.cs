...
using lumires.Api.Features.FilmPeople.GetDirectorStats;
...
internal sealed class GetDirectorStatsTests
{
    ...
    private void SetupDirectorFilms(int personId, params ExternalFilmShort[] films) =>
        _filmServiceMock
    ...
    public async Task Should_Return_FilmCount_And_AverageRating_Of_Rated_Films()
    {
        ...
        const int personId = 108;
        SetupDirectorFilms(personId,
            Film(1, 8.0f, 100),
            Film(2, 6.0f, 50),
            Film(3, 0f, 0));
        ...
        _awardsMock
            ...
            .ReturnsAsync(Result.Success(new PersonAwards(17, 6)));
        ...
        ep.Response.Awards!.Nominations.Should().Be(17);
        ep.Response.Awards.Wins.Should().Be(6);
    }
    ...
    public async Task Should_Return_Null_Awards_When_Scraping_Fails()
    {
        // Arrange
        const int personId = 108;
        SetupDirectorFilms(personId, Film(1, 7.0f, 10));
    ...
    public async Task Should_Return_Zero_AverageRating_When_No_Rated_Films()
    {
        ...
        const int personId = 108;
        SetupDirectorFilms(personId, Film(1, 0f, 0));
