...
namespace lumires.Api.Features.FilmPeople.GetActorStats;
...
internal sealed class Summary : Summary<Endpoint>
{
    public Summary()
    {
        Summary = "GetActorStats";
        Description = """
                      Returns aggregate stats for an actor sourced from TMDB:

                      - **FilmsCount** — number of films credited as cast
                      - **AverageRating** — mean rating (0–5 scale) across the actor's
        ...
        ExampleRequest = new Query(287);
        Response<Response>(200, "Actor stats retrieved successfully.");
