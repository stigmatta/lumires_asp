...
[UsedImplicitly]
internal sealed record TopRatedItem(Guid Id, int ExternalId, string Title, int VoteCount, string? BackdropPath);

[UsedImplicitly]
internal sealed record Response(IReadOnlyList<TopRatedItem> Items);
    ...
    : EndpointWithoutRequest<Response>
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var cacheKey = CacheKeys.ThisWeekTopRatedMovies(lang);
