...
using lumires.Api.Infrastructure.Auth;
...
{
    private static readonly Action<ILogger, string?, Exception?> LogMetadataParseError =
        LoggerMessage.Define<string?>(
            LogLevel.Error,
            new EventId(2, "AppMetadataParseError"),
            "Failed to parse Supabase app_metadata JSON for user {UserId}");
